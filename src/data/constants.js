...
export const experiences = [
  ...
  // },
  {
    ...
    desc: "Built World Connect Platforms using React Js integrated GraphQL with AXIOS, created High level Design and Figma design. Built Routs with React Router and Node JS and connected - Built Platform for managing data of Population for different countries.",
    skills: [
      "React",
      "React Router",
      "Axios",
  ...
  },
  {
    ...
    desc: "• Built Landing Pages - Astrologer App, with MVVM Architecture using Java and Android Studio integrating Firebase SDK. Created One to One video call integration with Socket.IO and Firebase cloud functions and integrated with Retrofit. Created Low Level Design and converted Figma design to XML code.",
    skills: [
      "Html",
      "Css",
      "Java Script",
